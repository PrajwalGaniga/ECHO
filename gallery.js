...
const linkedinPosts = [
    {thumbnail: 'ECHO-Websitelogo.jpg', title: 'ECHO Awarded "Best Technical Club 2024"', description: 'We are thrilled to be recognized for our contributions to technical education and community building.', link: 'https://linkedin.com'},
    {thumbnail: 'assets/images/gallery/linkedin-thumb2.jpg', title: 'New Partnership with TechCorp', description: 'ECHO is excited to announce a new strategic partnership to provide internship opportunities for our members.', link: 'https://linkedin.com'},
    {thumbnail: 'assets/images/gallery/linkedin-thumb3.jpg', title: 'Member Spotlight: Priya Patel', description: 'Our Vice President, Priya, was a keynote speaker at the National Women in Tech conference. Inspiring the next generation!', link: 'https://linkedin.com'},
    {thumbnail: '', title: 'Join Our Core Team!', description: 'Looking to develop leadership skills and make a difference? Applications for the ECHO Core Team are now open!', link: 'https://linkedin.com'}
];
